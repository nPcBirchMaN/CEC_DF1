...
declare module "@salesforce/schema/Case.Derivada__c" {
  const Derivada__c:any;
  export default Derivada__c;
}
declare module "@salesforce/schema/Case.Derivada__r" {
  const Derivada__r:any;
  export default Derivada__r;
}
...
declare module "@salesforce/schema/Case.N_mero_de_documento__c" {
